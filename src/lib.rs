...
impl WalletBranch {
    // 根据文件名解析并添加密钥
    pub fn add_key_from_filename(&mut self, filename: &str) {
    ...
    for entry in fs::read_dir(root)? {
        ...
        if path.is_dir() {
            ...
            let pk_filename = fs::read_dir(&root_dir)?
                ...
                .find(|e| e.file_name().to_string_lossy().ends_with("-pk"))
                .map(|e| e.file_name().to_string_lossy().to_string())
                .ok_or_else(|| anyhow::anyhow!("No -pk file found in root directory"))?;
            ...
            for subs_entry in fs::read_dir(subs_dir)? {
                ...
                if subs_path.is_file()
                    && subs_path
                        ...
                        .ends_with("-pk")
                {
                    wallet_branch.add_key_from_filename(
...
mod tests {
    ...
    fn test_traverse_directory_structure() -> Result<(), anyhow::Error> {
        ...
        // 执行目录结构遍历
        let wallet_tree = traverse_directory_structure(root_dir)?;
        ...
        //     wallet_a_branch
        //         .accounts
        //         .get("address-m_44'_60'_0'_0_0-pk")
        //         .unwrap(),
        ...
        //     wallet_a_branch
        //         .accounts
        //         .get("address-m_44'_60'_0'_0_1-pk")
        //         .unwrap(),
        ...
        //     wallet_a_branch
        //         .accounts
        //         .get("address-m_44'_60'_1'_0_0-pk")
        //         .unwrap(),
